"""Regression checks for the granite-data-quality-hub casebook."""
...
from casebook.harness import assert_expected, granite_data_quality_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(granite_data_quality_hub_summary(), assert_expected())
