...
$repo = "granite-data-quality-hub"
$language = "C++"
$category = "Data engineering"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/granite-data-quality-walkthrough.md")) {
